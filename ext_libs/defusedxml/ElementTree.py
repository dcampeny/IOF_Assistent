...
import sys
import warnings
from xml.etree.ElementTree import ParseError  # nosec — defusedxml importa el propi stdlib per embolcallar-lo de forma segura
from xml.etree.ElementTree import TreeBuilder as _TreeBuilder  # nosec — idem
from xml.etree.ElementTree import parse as _parse  # nosec — idem
from xml.etree.ElementTree import tostring  # nosec — idem

from .common import PY3

# IOF Assistent: qgisMinimumVersion=3.0 => sempre Python 3. S'elimina la
# branca de compatibilitat Python 2 (font original de l'avís F811 de
# flake8, ja que mai s'executava en aquest plugin).
import importlib
